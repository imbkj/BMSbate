...
<body>
	<script type="text/javascript">
		function Send() {
			window.location = "../EmBaseCompact/EmBaseCompactSA_GZDocOk.jsp?ebcc_id=<%=request.getParameter("ebcc_id")%>&user=<%=request.getParameter("user")%>&ebcu_tapr_id=<%=request.getParameter("ebcu_tapr_id")%>";
		}
	</script>
	<form id="form1">
