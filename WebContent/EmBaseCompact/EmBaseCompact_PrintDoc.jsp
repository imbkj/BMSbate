...
<body>
	<script type="text/javascript">
		function Send() {
			window.location = "../EmBaseCompact/EmBaseCompact_PrintDocOk.jsp?ebcc_id=<%=request.getParameter("ebcc_id")%>&user=<%=request.getParameter("user")%>&ebcc_tapr_id=<%=request.getParameter("ebcc_tapr_id")%>";
		}
		function Print() {
