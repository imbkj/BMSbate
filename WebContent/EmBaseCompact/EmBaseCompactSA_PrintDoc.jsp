...
<%
	...
	poCtrl.addCustomToolButton("转待盖章", "Send", 2);
	//设置保存页面
...
<body>
	<script type="text/javascript">
		...
		function Send() {
			window.location = "../EmBaseCompact/EmBaseCompactSA_PrintDocOk.jsp?ebcc_id=<%=request.getParameter("ebcc_id")%>&user=<%=request.getParameter("user")%>&ebcu_tapr_id=<%=request.getParameter("ebcu_tapr_id")%>";
		}
	</script>
	<form id="form1">
