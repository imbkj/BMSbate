...
<% 
	...
	String user = dal.getUsernameById(userid);
	 //链接数据库操作开始
	 //String sql = "update EmBaseCompactChange set ebcc_state=2 where ebcc_id="+ebcc_id;
	 //stmt.executeUpdate(sql); 
	 //String sql2 = "update EmBaseCompact set ebco_state=2 from EmBaseCompactChange where ebcc_ebco_id=ebco_id and ebcc_id="+ebcc_id;
...
<body>
	<script type="text/javascript">
		alert('审核成功！');
		//window.location.href = '../EmBaseCompact/EmBaseCompact_AutList.zul';
	</script>
</body>
</html>