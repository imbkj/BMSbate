...
<% 
	...
	String user = dal.getUsernameById(userid);
	 //链接数据库操作开始
	 //String sql = "update EmBaseCompactChange set ebcc_state=1 where ebcc_id="+ebcc_id;
	 //stmt.executeUpdate(sql); 
	 //String sql2 = "update EmBaseCompact set ebco_state=1 from EmBaseCompactChange where ebcc_ebco_id=ebco_id and ebcc_id="+ebcc_id;
	...
	wf.PassToNext(obj, ebcc_tapr_id, user, "", cid, "");
%>
...
<body>
	<script type="text/javascript">
		alert('发送成功！');
		//window.location.href = '../EmBaseCompact/EmBaseCompact_MakeList.zul';
	</script>
</body>
</html>