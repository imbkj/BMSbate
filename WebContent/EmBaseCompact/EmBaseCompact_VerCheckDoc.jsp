...
<%
	...
	//判断文档是否暂存
	String sql2="";
	if(request.getParameter("ver_temp").equals("1")){
	sql2 = "select * from CompactVer where ebct_id="
			+ request.getParameter("id") ;
	}

	if(request.getParameter("ver_temp").equals("2")){
	sql2 = "select * from EmBaseCompactTemplate where ebct_id="
			+ request.getParameter("id") ;
	}
