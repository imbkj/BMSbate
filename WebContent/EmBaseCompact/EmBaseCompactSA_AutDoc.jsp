...
<body>
	<script type="text/javascript">
		...
		function Send() {
			document.getElementById("PageOfficeCtrl1").WebSave();
			window.location = "../EmBaseCompact/EmBaseCompactSA_AutDocOk.jsp?ebcc_id=<%=request.getParameter("ebcc_id")%>&user=<%=request.getParameter("user")%>&ebcu_tapr_id=<%=request.getParameter("ebcu_tapr_id")%>";
		}
	</script>
	<form id="form1">
