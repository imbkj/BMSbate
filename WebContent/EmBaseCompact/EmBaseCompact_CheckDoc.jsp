...
<%
	...
	//判断文档是否暂存
	String sql2 = "select count(*),puof_url from EmBaseCompactChange a left join PubOffice b on b.puof_tid=a.ebcc_id where puof_pute_id=3 and a.ebcc_id="
			+ request.getParameter("ebcc_id") + " and ebcc_change<>'终止' and ebcc_change<>'解除' group by puof_url";
