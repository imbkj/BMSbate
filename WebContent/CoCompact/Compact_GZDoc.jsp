...
<%
	...
	poCtrl.addCustomToolButton("已盖章", "Save", 1);
	//设置保存页面
...
<body>
	<script type="text/javascript">
		function Save() {
			...
			window.location = "../CoCompact/Compact_GZOk.jsp?coco_id=<%=request.getParameter("coco_id")%>&coco_tapr_id=<%=request.getParameter("coco_tapr_id")%>&user=<%=request.getParameter("user")%>&coco_class=<%=request.getParameter("emco_class")%>&coco_autst=4";
		}
