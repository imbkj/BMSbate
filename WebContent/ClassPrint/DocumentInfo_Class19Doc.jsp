...
<%
	...
	//链接数据库操作开始
    String sql="select top 1 coba_company,emba_name,coba_company,h.Esiu_ComputerID,h.esiu_idcard,i.Ownmonth,cast(year(getdate()) as varchar(4)) y, "
