...
<%
	...
	//链接数据库操作开始
    String sql="select distinct a.gid,emba_name,emba_idcard,coba_company,isnull(ebco_working_station,'') ebco_working_station, "
	...
	poCtrl.webOpen("../ClassPrint/class12.doc",
				OpenModeType.docAdmin, "szciic");
		//设置页面的显示标题
	poCtrl.setCaption("标准版在职证明");
