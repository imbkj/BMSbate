...
<%
    ...
    String sql="select  distinct emba_name,emba_idcard , cast(year(getdate()) as varchar(4)) y,cast(month(getdate()) as varchar(4)) m, "
               ...
               +" where a.gid="+Integer.parseInt(request.getParameter("gid"))+" and Esiu_hj  like '%市外%' and a.emba_state in(1,2,5) ";
	...
	poCtrl.webOpen("../ClassPrint/class4.doc",
				OpenModeType.docAdmin, "szciic");
		//设置页面的显示标题
	poCtrl.setCaption("同志在职证明");
