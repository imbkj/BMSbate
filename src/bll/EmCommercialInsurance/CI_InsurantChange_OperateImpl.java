...
public class CI_InsurantChange_OperateImpl implements WfBusinessService {
	...
	public String[] Operate(Object[] obj) {
		...
		if (i == "1") {
			...
			message = AutChangeInsurant(obj);
		} else if (i == "10") {
			message = DelInsurant(obj);
		}
	...
	public String[] StopOperate(Object[] obj) {
		...
		try {
			result = dal.ecin_del(obj[1].toString());
	...
	public Boolean UpdateTaprid(int dataId, int tapr_id, int state) {
		try {
			ccsaDal.upinsurantchangeid(dataId, tapr_id);
			return true;
		} catch (Exception e) {
			return false;
		}
	...
	// 商业保险信息变更审核
	public String[] AutChangeInsurant(Object[] obj) {
		int result = 0;
		String[] message = new String[5];
		CI_Insurant_OperateDal dal = new CI_Insurant_OperateDal();
		result = dal.AutChange_Insurant(obj[1].toString());
		//System.out.println("-----");
		//System.out.println(obj[1].toString());
		if (result != 0) {
			message[0] = "1";
			message[1] = "商业保险信息变更审核成功!";
			message[2] = String.valueOf(result);
			message[3] = "ci_insurant";
			message[4] = "商业保险信息变更审核";
		} else {
			message[0] = "0";
			message[1] = "商业保险信息变更审核失败!";
		}
		return message;
	}
	...
	// 商业保险新增申报
		public String[] DelInsurant(Object[] obj) {
			int result = 0;
			String[] message = new String[5];
			CI_Insurant_OperateDal dal = new CI_Insurant_OperateDal();
			try {
