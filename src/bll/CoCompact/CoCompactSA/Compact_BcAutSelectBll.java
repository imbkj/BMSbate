...
import dal.CoCompact.CoCompactSA.Compact_BcAutSelectDal;

public class Compact_BcAutSelectBll {
	private Compact_BcAutSelectDal ccbDal = new Compact_BcAutSelectDal();
