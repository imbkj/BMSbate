...
//部门经理审核类
public class EmPa_FinanceApprovalImpl implements EmPa_Approval {
	private EmPayModel model;

	public EmPa_FinanceApprovalImpl(EmPayModel model) {
		this.model = model;
	}
	...
	public Integer Approval() {
		...
		Integer k = dal.FinanceApproval(model.getCheckState(), model);
		if (k>0) {
			log();
		}
