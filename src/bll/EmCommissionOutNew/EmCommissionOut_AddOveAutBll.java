...
import dal.EmCommissionOutNew.EmCommissionOut_AddOveAutDal;
import Model.EmCommissionOutFeeDetailChangeModel;

public class EmCommissionOut_AddOveAutBll {
	EmCommissionOut_AddOveAutDal dal = new EmCommissionOut_AddOveAutDal();
	...
	public int getstateover(String ecoc_id, String co_date, String em_date)
			throws SQLException {
		return dal.getstateover(ecoc_id, co_date + "-01", em_date + "-01");
	}
