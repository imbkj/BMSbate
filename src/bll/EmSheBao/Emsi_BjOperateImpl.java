...
public class Emsi_BjOperateImpl implements WfBusinessService {
	...
	public String[] Operate(Object[] obj) {
		...
		try {
			...
			if ("0".equals(obj[0].toString())) {
				...
				int i = dal.upBjDeclare(Integer.parseInt(obj[1].toString()), 8,
	...
	public String[] ReturnOperate(Object[] obj) {
		...
		try {
			...
			if ("0".equals(obj[0].toString())) {
				Emsi_CheckOperateDal dal = new Emsi_CheckOperateDal();
				int i = dal.upBjDeclare(Integer.parseInt(obj[1].toString()), 3,
						obj[2].toString(), obj[3].toString());
				if(i>0){
					message[0] = "1";
					message[1] = "操作成功。";
