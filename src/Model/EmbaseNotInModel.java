...
public class EmbaseNotInModel {
	...
	// / emba_computerid
	private Integer emba_computerid;
	// / emba_hand
	...
	// / emba_housetype
	private Integer emba_housetype;
	// / emba_houseclass
	private Integer emba_houseclass;
	// / emba_skilllevel
	private Integer emba_skilllevel;
	// / emba_worktime
	...
	// / emba_regtype
	private Integer emba_regtype;
	// / emba_compactlimit
	private Integer emba_compactlimit;
	// / emba_compactstart
	...
	// / emba_sbage1
	private Integer emba_sbage1;
	// / emba_sbage2
	private Integer emba_sbage2;
	// / emba_sbage3
	private Integer emba_sbage3;
	// / emba_sbage4
	private Integer emba_sbage4;
	// / emba_sbidcard1
	...
	// / emba_hospital
	private Integer emba_hospital;
	// / emba_bcaddress
	private Integer emba_bcaddress;
	// / emba_bctime
	...
	private String emba_form;
	private String emba_statstr;
	
	public EmbaseNotInModel(){
		
	}

	public EmbaseNotInModel(Integer emba_id, Integer gid, Integer cid,
			String emba_name, String emba_englishname, String emba_spell,
			String emba_sex, String emba_idcard, String emba_idcardclass,
			String emba_mobile, Integer emba_state, String emba_remark,
	...
	public EmbaseNotInModel(Integer emba_id, Integer gid, Integer cid,
			...
			String emba_sex, String emba_idcard, String emba_idcardclass,
			String emba_mobile, Integer emba_state, String emba_remark,
			String emba_wt, String coba_name, String coba_client,String emba_form, String emba_statstr,Integer emba_type) {
		super();
		this.emba_id = emba_id;
		this.gid = gid;
		this.cid = cid;
		...
		if (emba_state==1)
		{
			this.emba_statstr="已入职";
		}
		else if (emba_state==0)
		{
			this.emba_statstr="未入职";
		}else if (emba_state==2)
		{
			this.emba_statstr="已采集";
		}
	...
	public String getEmba_form() {
		if (emba_form.equals("1"))
		{
			emba_form="安卓终端";
		}
		else if (emba_form.equals("2"))
		{
			emba_form="苹果终端";
		}
		else if (emba_form.equals("3"))
		{
			emba_form="网上中智";
		}
		else if (emba_form.equals("0"))
		{
			emba_form="系统";
		}
		return emba_form;
	...
	public void setEmba_form(String emba_form) {
		
		if (emba_form.equals("安卓终端"))
		{
			emba_form="1";
		}
		else if (emba_form.equals("苹果终端"))
		{
			emba_form="2";
		}
		else if (emba_form.equals("网上中智"))
		{
			emba_form="3";
		}
		else if (emba_form.equals("系统"))
		{
			emba_form="0";
		}
	...
	public String getEmba_statstr() {
	 
		return emba_statstr;
	}

	public void setEmba_statstr(int emba_state) {
	...
	public Integer getEmba_computerid() {
		return emba_computerid;
	}

	public void setEmba_computerid(Integer emba_computerid) {
	...
	public Integer getEmba_housetype() {
		return emba_housetype;
	}

	public void setEmba_housetype(Integer emba_housetype) {
		this.emba_housetype = emba_housetype;
	}

	public Integer getEmba_houseclass() {
		return emba_houseclass;
	}

	public void setEmba_houseclass(Integer emba_houseclass) {
		this.emba_houseclass = emba_houseclass;
	}

	public Integer getEmba_skilllevel() {
		return emba_skilllevel;
	}

	public void setEmba_skilllevel(Integer emba_skilllevel) {
	...
	public Integer getEmba_regtype() {
		return emba_regtype;
	}

	public void setEmba_regtype(Integer emba_regtype) {
		this.emba_regtype = emba_regtype;
	}

	public Integer getEmba_compactlimit() {
		return emba_compactlimit;
	}

	public void setEmba_compactlimit(Integer emba_compactlimit) {
	...
	public Integer getEmba_sbage1() {
		return emba_sbage1;
	}

	public void setEmba_sbage1(Integer emba_sbage1) {
		this.emba_sbage1 = emba_sbage1;
	}

	public Integer getEmba_sbage2() {
		return emba_sbage2;
	}

	public void setEmba_sbage2(Integer emba_sbage2) {
		this.emba_sbage2 = emba_sbage2;
	}

	public Integer getEmba_sbage3() {
		return emba_sbage3;
	}

	public void setEmba_sbage3(Integer emba_sbage3) {
		this.emba_sbage3 = emba_sbage3;
	}

	public Integer getEmba_sbage4() {
		return emba_sbage4;
	}

	public void setEmba_sbage4(Integer emba_sbage4) {
	...
	public Integer getEmba_hospital() {
		return emba_hospital;
	}

	public void setEmba_hospital(Integer emba_hospital) {
		this.emba_hospital = emba_hospital;
	}

	public Integer getEmba_bcaddress() {
		return emba_bcaddress;
	}

	public void setEmba_bcaddress(Integer emba_bcaddress) {
