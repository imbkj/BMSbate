...
public class EmBaseCompactBModel {
	// / 自动编号
		private int ebco_id;
		// / 雇员编号
		private String gid;
		...
		// / 试用期起始日
		private Date ebco_probation_incept;
		// / 试用到期时间
		private Date ebco_probation_mdate;
		// / 月工资
		...
		public Date getEbco_incept_date() {
			return ebco_incept_date;
		}
		public void setEbco_incept_date(Date ebco_incept_date) {
		...
		public Date getEbco_probation_incept() {
			return ebco_probation_incept;
		}
		public void setEbco_probation_incept(Date ebco_probation_incept) {
			this.ebco_probation_incept = ebco_probation_incept;
		}
		public Date getEbco_probation_mdate() {
			return ebco_probation_mdate;
		}
		public void setEbco_probation_mdate(Date ebco_probation_mdate) {
