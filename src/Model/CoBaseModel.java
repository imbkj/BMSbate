...
public class CoBaseModel {
	...
	private CollectAmountModel amount;
	...
	private Integer cfss_fpfrist;

	private String cfss_addtime;
	private String cfss_remark;
	private String cfss_addname;
	private String cfss_modname;
	private String cfss_modtime;
	...
	public CoBaseModel(int coba_id, Integer cid, String coba_shortname,
			...
			String coba_ufclass, String coba_clientclass,
			String coba_invoicerule, String coba_invoiceaddress,
			String coba_wtco, String coba_regdataList, String coba_assistant,
			String coba_zytcid, String coba_developer, int coba_gzautoemail,
			int coba_sign, String coba_invoice, String coba_taxmonth,
			String coba_gzaddname, String coba_gzaudname, int coba_gzemailtype,
			...
			String coba_zytwtcid, int coba_gzautoemaildays, Integer peopnum,
			String coconum, Integer pronum, int log_id, int cou, boolean fuzzy,
			String coba_kind, String company,
			List<CoFinanceCollectModel> cfcms, CollectAmountModel amount,
			String msg_a, String coba_ifhasbribery, String coba_fpremark,
			String coba_regaccount, String coba_regaccountpwd, Date makedate,
			String makenumber, String zaiyao, int group_count,
			int group_firstrow, int group_order, String cfmb_remark,
			String cfta_addtime, Integer ownmonth, String cfmb_number,
			String outstate, String cohf_houseid, String cfss_cfso_id,
			BigDecimal total, Boolean checked, String cfss_type,
			String cfss_fpstate) {
		super();
	...
	public CollectAmountModel getAmount() {
		return amount;
	}

	// 设置收款
	public void setAmount(List<CoFinanceCollectModel> amounts) {
		CollectAmountModel a = new CollectAmountModel();
	...
	public void setAmount(CollectAmountModel amount) {
		this.amount = amount;
	}
	...
	public Integer getCfss_fpfrist() {
		return cfss_fpfrist;
	}

	public void setCfss_fpfrist(Integer cfss_fpfrist) {
	...
	public String getCfss_remark() {
		return cfss_remark;
	}

	public void setCfss_remark(String cfss_remark) {
		this.cfss_remark = cfss_remark;
	}
	...
	public String getCfss_modname() {
		return cfss_modname;
	}

	public void setCfss_modname(String cfss_modname) {
		this.cfss_modname = cfss_modname;
	}

	public String getCfss_modtime() {
		return cfss_modtime;
	}

	public void setCfss_modtime(String cfss_modtime) {
		this.cfss_modtime = cfss_modtime;
	}
