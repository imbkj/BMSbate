...
public class CoFinanceCollectModel {
	...
	public String getCfta_modname() {
		return cfta_modname;
	}



	public void setCfta_modname(String cfta_modname) {
		this.cfta_modname = cfta_modname;
	}
