...
public class EmBaseCompactListModel {
	// / 自动编号
	private int ebco_id;
	// /公司名称
	...
	private int ebco_tapr_id;
	
	private String ebct_class;
	///合同模板类型
	
	public int getEbco_tapr_id() {
		return ebco_tapr_id;
	}

	public void setEbco_tapr_id(int ebco_tapr_id) {
		this.ebco_tapr_id = ebco_tapr_id;
	}
	...
	public String getEbct_class() {
		return ebct_class;
	}

	public void setEbct_class(String ebct_class) {
		this.ebct_class = ebct_class;
	}
