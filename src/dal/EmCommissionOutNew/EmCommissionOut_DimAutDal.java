...
public class EmCommissionOut_DimAutDal {
	// 获取委托主表明细
	public EmCommissionOutChangeModel getwt_list(String ecoc_id)
		...
		try {
			...
			while (rs.next()) {
				...
				list.setEcoc_state(rs.getInt("ecoc_state"));
	...
	public List<EmCommissionOutFeeDetailChangeModel> getfeedetail(String ecoc_id)
		...
		String sqlstr = "select eofc_ecoc_id,eofc_name,eofc_em_base,eofc_co_base,eofc_op,eofc_cp,eofc_month_sum,eofc_stop_date,eofc_sicl_id from EmCommissionOutFeeDetailChange where eofc_ecoc_id="
				+ ecoc_id
