...
public class BatP_embaseDal {
	private dbconn conn;

	public BatP_embaseDal() {
		conn = new dbconn();
	}
...
//		}
		...
		public EmbaseModel checkdata(EmbaseModel em)
		{
			...
			if(em.getEmba_mobile()==null || em.getEmba_mobile().equals("") || em.getEmba_mobile().length()!=11)
			{
				err.append("导入手机格式有误！");
			}
			...
			if (em.getEmba_nationality().equals("中国"))
			{
				...
				//if (em.getEmba_idcardclass().equals("身份证")) {
					if (em.getEmba_idcard() != null
						...
						em.setEmba_birth(DateStringChange.DatetoSting(IdcardUtil.getBirthByIdCard2(em
								.getEmba_idcard()),"yyyy-MM-dd" ));
