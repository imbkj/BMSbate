...
public class EmDh_LxProxyConfirmController {
	...
	public EmDh_LxProxyConfirmController() {
	...
	{
		if(dhmodel.getProxytime()==null)
		{
			Messagebox.show("请选择受理日期", "提示", Messagebox.OK, Messagebox.ERROR);
			return;
		}
		EmDh_LxConreoller lxController=new EmDh_LxConreollerImpl("代理部受理");
