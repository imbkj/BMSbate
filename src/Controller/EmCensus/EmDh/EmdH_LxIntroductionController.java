...
public class EmdH_LxIntroductionController {
	...
	public EmdH_LxIntroductionController() {
	...
	{
		if(dhmodel.getEmdh_time8()==null)
		{
			Messagebox.show("请选择受理日期", "提示", Messagebox.OK, Messagebox.ERROR);
			return;
		}
		EmDh_LxConreoller lxController=new EmDh_LxConreollerImpl("介绍信下达");
