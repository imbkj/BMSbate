...
public class EmDh_LxReportDataController {
	...
	public EmDh_LxReportDataController() {
	...
	{
		if(dhmodel.getEmdh_time7()==null)
		{
			Messagebox.show("请选择上报材料日期", "提示", Messagebox.OK, Messagebox.ERROR);
			return;
		}
		EmDh_LxConreoller lxController=new EmDh_LxConreollerImpl("上报材料");
