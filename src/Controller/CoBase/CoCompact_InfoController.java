...
public class CoCompact_InfoController {
	String cocoid = (String) Executions.getCurrent().getArg().get("coco_id").toString();
	...
	public CoCompact_InfoController() throws SQLException {
		modellist = cocoBll.searchCoCoBase(cocoid);
