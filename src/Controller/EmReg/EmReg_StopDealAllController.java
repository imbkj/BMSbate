...
public class EmReg_StopDealAllController {
	private List<EmRegistrationInfoModel> list= (List<EmRegistrationInfoModel>) Executions.getCurrent().getArg().get("list");
	...
	public void submit(@BindingParam("win") Window win)
	{
		...
		for(EmRegistrationInfoModel model:list)
		{
