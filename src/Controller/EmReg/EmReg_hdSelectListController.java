...
public class EmReg_hdSelectListController {
	...
	String wherestr = " and type=1 and typename='后道状态' and state=1 and erin_reg_state=1";
	...
	public EmReg_hdSelectListController() {
		try {
