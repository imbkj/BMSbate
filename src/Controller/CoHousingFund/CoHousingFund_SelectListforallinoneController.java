...
public class CoHousingFund_SelectListforallinoneController {
	...
	public CoHousingFund_SelectListforallinoneController() {
		try {
			init();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void init() {
		...
		try {
			setCohfList(bll.getCoHoList(" and a.cid="+cbm.getCid()+"",false));
