...
public class CoHousingFund_TerminationController {
	Integer daid = 0;
	...
	public CoHousingFund_TerminationController() {
		try {
	...
	public void init() {
		...
		try {
			...
			chfcModel.setChfc_addtype("降低比例/缓缴提前终止");
			...
			chfcModel.setChfc_ifstop_low(false);
			chfcModel.setChfc_ifstop_hj(false);
