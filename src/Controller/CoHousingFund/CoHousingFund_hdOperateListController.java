 ...
 * 
 */
public class CoHousingFund_hdOperateListController {
	...
	public CoHousingFund_hdOperateListController() {
		try {
			init();
		} catch (Exception e) {
			e.printStackTrace();
	...
	@Command
	@NotifyChange({ "schfcList" })
	public void upload(@BindingParam("a") CoHousingFundChangeModel m){
		Map map = new HashMap();
		map.put("m", m);
		Window window = (Window) Executions.createComponents(
				"CoHousingFund_hdUpload.zul", null, map);
		window.doModal();
		setChfcList(bll.getCoHoChangeList(""));
		search();
	}
	...
	public final List<CoHousingFundChangeModel> getChfcList() {
		return chfcList;
	}

	public final List<CoHousingFundChangeModel> getSchfcList() {
		return schfcList;
	}
	...
	public final void setChfcList(List<CoHousingFundChangeModel> chfcList) {
		this.chfcList = chfcList;
	}

	public final void setSchfcList(List<CoHousingFundChangeModel> schfcList) {
