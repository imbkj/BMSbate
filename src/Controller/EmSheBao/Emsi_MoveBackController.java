...
public class Emsi_MoveBackController {
	...
	public Emsi_MoveBackController() {
		if (checkInit())
			return;
	...
	public void movein(@BindingParam("win") Window win,
		...
		try {
			if (checkPage()) {
				...
				String[] message = opbll.moveback(m);
			...
			Messagebox.show("社保调回出错。", "操作提示", Messagebox.OK, Messagebox.ERROR);
		}
	}
