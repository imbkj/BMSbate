...
public class Emsc_BJFileUploadAllController {
	...
	public Emsc_BJFileUploadAllController() {
		list = (List<EmShebaoBJModel>) Executions.getCurrent().getArg()
				.get("list");
	}
	...
	public void submit(@BindingParam("win") final Window win,
		...
		if (this.media != null) {
			...
			if (FileOperate.upload(media, uploadfolder + uploadName)) {
				String msg = "";
				for (EmShebaoBJModel bjModel : list) {
