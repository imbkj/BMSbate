...
public class Emsi_NewinController {
	...
	private boolean checkInit() {
		...
		if (chkStr!=null) {
			existsShebao = true;
			existsMessage = "该员工在另一家公司-("+chkStr[1]+")"+chkStr[2]+"-存在在册社保数据，请先操作停交再操作新增！";
			return existsShebao;
		} else {
