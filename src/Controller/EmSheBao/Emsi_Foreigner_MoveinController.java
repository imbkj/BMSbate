...
public class Emsi_Foreigner_MoveinController {
	...
	public Emsi_Foreigner_MoveinController() {
		if (checkInit())
			return;
	...
	public void movein(@BindingParam("win") Window win,
		...
		try {
			if (checkPage()) {
				...
				String[] message = opbll.moveinForeigner(m);
			...
			Messagebox.show("外籍人社保调回出错。", "操作提示", Messagebox.OK,
					Messagebox.ERROR);
		}
	}
