...
import bll.EmCommissionOutNew.EmCommissionOut_ChangeReBll;
...
public class EmCommissionOut_ChangeReController {
	...
	EmCommissionOut_ChangeReBll bll = new EmCommissionOut_ChangeReBll();
	...
	public void submit(@BindingParam("sb_base") Doublebox sb_base,
			...
			@BindingParam("compact_f") Datebox compact_f,
			@BindingParam("compact_l") Datebox compact_l,
		...
		String compact_f_s = "";
		if (compact_f.getValue() != null) {
			compact_f_s = ccsaBll.DatetoSting(compact_f.getValue());
		}

		String compact_l_s = "";
		if (compact_l.getValue() != null) {
			compact_l_s = ccsaBll.DatetoSting(compact_l.getValue());
		}
		...
		if (ecou_count > 8) {
			String[] message = ccsaBll.changeRe(wt_list, daid, new BigDecimal(
					...
					compact_f_s, compact_l_s,wt_name);
