...
public class Empa_clientManagerListController {
	...
	private String sql = " and empa_state in(1)";

	public Empa_clientManagerListController() {
		m.setEmpa_state(1);
	...
	public void singleUpdate(@BindingParam("model") EmPayModel model) {
		...
		Window window = (Window) Executions.createComponents(
				"Empa_ClientManagerApproval.zul", null, map);
		window.doModal();
		list = bll.getEmPayInfoList(sql);
	}
