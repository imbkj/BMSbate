...
public class Empa_assistantListController {
	...
	public Empa_assistantListController() {
		// 部门总经理助理只能查询自己部门添加的数据
		sql = "and empa_state=3 and empa_addname in(select log_name from Login "
