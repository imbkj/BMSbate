...
public class CoReg_OperateListController {
	...
	@Command("back")
	@NotifyChange("scoregList")
	public void back(@BindingParam("company") String company,
			@BindingParam("daid") Integer daid, @BindingParam("id") Integer id) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("daid", daid);
		map.put("company", company);
		map.put("id", id);
		Window win = (Window) Executions.createComponents("CoReg_Back.zul",
				null, map);
		win.doModal();
