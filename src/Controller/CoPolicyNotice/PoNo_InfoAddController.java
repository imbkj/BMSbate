...
public class PoNo_InfoAddController {
	private String type = (String) Executions.getCurrent().getArg().get("type");
	// 城市
	private String classname = (String) Executions.getCurrent().getArg()
			.get("classname");
	private CoAgencyBaseCityRelModel citymodel = (CoAgencyBaseCityRelModel) Executions
