...
import bll.CoCompact.CoCompactSA.Compact_BcAutSelectBll;

public class Compact_BcAutSelectController {
	private List cocoBaseList; // 合同基本信息列表
	private List cocoAddnameList; // 添加人列表
	private Compact_BcAutSelectBll cocoBll = new Compact_BcAutSelectBll();
	...
	public Compact_BcAutSelectController() {
		// 首页加载显示所有数据
