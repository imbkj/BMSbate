...
public class Compact_SignListController {
	...
	public Compact_SignListController() {
		// 首页加载显示已打印的数据
		cocoBaseList = cocoBll.searchCoCoBaseList(coco_company, coco_compactid,
				"3", coco_addname, "", "");
		// 查询中添加人下拉框
		cocoAddnameList = cocoBll.getCoCoAddname("AND coco_state=3");
	}
	...
	// 弹出公司合同签回页面
	@Command("openCompact_Sign")
	@NotifyChange("cocoBaseList")
	public void openCompact_Sign(@BindingParam("cocoM") CoCompactModel cocoM) {
		// 专递cocoM
		Map map = new HashMap();
