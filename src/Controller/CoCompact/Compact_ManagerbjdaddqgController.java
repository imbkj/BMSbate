...
public class Compact_ManagerbjdaddqgController {
	...
	public Compact_ManagerbjdaddqgController() {
	...
	public void itemAdd(@BindingParam("a") CoCompactModel cocoM) {
		...
		Window window = (Window) Executions.createComponents(
				"/CoQuotation/Coquotation_ItemAddqg.zul", null, map);
		window.doModal();
		search();
	...
	public void query(@BindingParam("a") CoCompactModel cocoM) {
		...
		Window window = (Window) Executions.createComponents(
				"../CoBase/CoCompact_Infoqg.zul", null, map);
		window.doModal();
	}
