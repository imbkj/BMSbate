...
public class CoSocialInsurance_CancellationDetailController {
	private CoShebaoChangeModel m = new CoShebaoChangeModel();
	private List<PubStateRelModel> hosList = new ListModelList<>();
	Integer daid = 0;

	public CoSocialInsurance_CancellationDetailController() {
		try {
			...
			setHosList(bll.getHosList(daid, " and pbsr_type='csoican'"));
