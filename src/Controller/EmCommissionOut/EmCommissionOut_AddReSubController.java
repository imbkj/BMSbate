...
public class EmCommissionOut_AddReSubController {
	...
	public EmCommissionOut_AddReSubController() {
		try {
	...
	public void submit(@BindingParam("win") Window win) {
		...
		m.setRemark("重新提交;" + m.getEcoc_remark1() == null ? "" : m
				.getEcoc_remark1());

		try {
			for (EmCommissionOutFeeDetailChangeModel m : feeList) {
				m.setEofc_start_date(m.getTempDate() == null ? null
						: DateStringChange.DatetoSting(m.getTempDate(),
								"yyyy-MM-01"));
			}
