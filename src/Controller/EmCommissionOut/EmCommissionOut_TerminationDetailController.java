...
public class EmCommissionOut_TerminationDetailController {
	...
	public EmCommissionOut_TerminationDetailController() {
		try {
	...
	public void init() {
		...
		try {
			setM(bll.getEmCommOutChangeInfo(daid, " and type='ecocter'"));
