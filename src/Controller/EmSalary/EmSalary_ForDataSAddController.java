...
public class EmSalary_ForDataSAddController {
	...
	public EmSalary_ForDataSAddController() {
		// 获取最新所属月份
	...
	// 提交事件
	@Command("submit")
	public void submit(@BindingParam("winForDataAdd") final Window winForDataAdd) {

		// 调用方法
		String[] message = ifOBll.addFormulaData(String.valueOf(cfin_id),
				csii_id, formula, t_formula, range, t_range, username);

		// 排序
		ifOBll.createFormula(Integer.parseInt(cid), ownmonth, cfin_id);
