...
public class Embase_InlistController{
	private String str = "";
	private String strs = "";
	...
	public Embase_InlistController() {
	...
	public void embasein(@BindingParam("model") CoBaseModel cobaM,@BindingParam("a") int a) {
