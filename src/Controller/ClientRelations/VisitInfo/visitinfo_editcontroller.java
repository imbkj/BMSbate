...
public class visitinfo_editcontroller  extends SelectorComposer<Component> {
private static final long serialVersionUID = 1L;
	...
	public visitinfo_editcontroller()
	{
			...
			try{
				 ...
				 //遍历row
				    for(Object obj:row){
				      ...
				      {
				    	  i=i+visitinfob.deleteing(checksel.getValue().toString());
				      }
	...
	//查询客服数据权限列表
		...
		@Command("update")
		@NotifyChange("visitInfolist")
		public void update(@BindingParam("viinM") VisitInfoModel viinM){
			Map viinMap = new HashMap();
			viinMap.put("viinM", viinM);
			Window window = (Window) Executions.createComponents(
					"LatencyClientVisit_Update.zul", null, viinMap);
			window.doModal();
			visitInfolist=visitinfob.getlist(viin_person, viin_month, cola_company, "", viin_addname,0);
		}
